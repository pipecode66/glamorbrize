...
import MicrofibraCollection from "@/components/batas-glamor/microfibra-collection"
...
export default function MicrofibraPage() {
  return (
    <div className="flex min-h-screen flex-col">
      {/* Hero Banner - Responsive */}
      <section
        className="relative py-6 sm:py-8 md:py-12 lg:py-16"
        style={{ backgroundColor: batasGlamorColors.accent + "20" }}
      >
        <div className="container mx-auto px-4">
          <div className="relative max-w-6xl mx-auto">
            ...
            <div className="relative h-[35vh] sm:h-[40vh] md:h-[45vh] lg:h-[50vh] xl:h-[55vh] rounded-lg sm:rounded-xl lg:rounded-2xl overflow-hidden shadow-lg sm:shadow-xl lg:shadow-2xl">
              <Image
                src="/images/design-mode/LINEA%20MICROFIBRA.png"
                alt="Colección Microfibra"
                fill
            ...
            <div className="absolute -inset-2 sm:-inset-3 lg:-inset-4 bg-gradient-to-r from-teal-600/10 via-cyan-600/10 to-blue-600/10 rounded-xl sm:rounded-2xl lg:rounded-3xl blur-lg sm:blur-xl -z-10 hidden sm:block"></div>
          </div>
        </div>
      </section>
      ...
      <div className="border-b py-2 sm:py-3 md:py-4" style={{ borderColor: batasGlamorColors.lightGray + "30" }}>
        <div className="container mx-auto px-4">
          <div className="flex text-xs sm:text-sm">
            ...
            <span className="mx-1 sm:mx-2 text-muted">/</span>
            <span style={{ color: batasGlamorColors.secondary }}>Microfibra</span>
          </div>
        </div>
      </div>

      {/* Colección Microfibra */}
      <MicrofibraCollection colors={batasGlamorColors} />

      {/* Pedidos Empresariales - Responsive */}
      <section className="py-8 sm:py-12 md:py-16 lg:py-20" style={{ backgroundColor: batasGlamorColors.accent + "20" }}>
        <div className="container mx-auto px-4">
          <h2
