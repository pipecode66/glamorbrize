...
import SedaCollection from "@/components/batas-glamor/seda-collection"
...
export default function SedaPage() {
  return (
    <div className="flex min-h-screen flex-col">
      {/* Hero Banner - Responsive */}
      <section
        className="relative py-6 sm:py-8 md:py-12 lg:py-16"
        style={{ backgroundColor: batasGlamorColors.accent2 + "20" }}
      >
        <div className="container mx-auto px-4">
          <div className="relative max-w-6xl mx-auto">
            ...
            <div className="absolute -inset-2 sm:-inset-3 lg:-inset-4 bg-gradient-to-r from-pink-600/10 via-rose-600/10 to-red-600/10 rounded-xl sm:rounded-2xl lg:rounded-3xl blur-lg sm:blur-xl -z-10 hidden sm:block"></div>
          </div>
        </div>
      </section>
      ...
      <div className="border-b py-2 sm:py-3 md:py-4" style={{ borderColor: batasGlamorColors.lightGray + "30" }}>
        <div className="container mx-auto px-4">
          <div className="flex text-xs sm:text-sm">
            ...
            <span className="mx-1 sm:mx-2 text-muted">/</span>
            <span style={{ color: batasGlamorColors.secondary }}>Seda</span>
          </div>
        </div>
      </div>

      {/* Colección Seda */}
      <SedaCollection colors={batasGlamorColors} />
      ...
      >
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <Link
                href="https://wa.me/573156614208?text=Hola,%20quiero%20cotizar%20la%20linea%20de%20batas%20en%20seda"
                target="_blank"
