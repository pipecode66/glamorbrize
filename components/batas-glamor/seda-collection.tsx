...
export default function SedaCollection({ colors = batasGlamorColors }: SedaCollectionProps) {
  ...
  const quoteHref = "https://wa.me/573156614208?text=Hola,%20quiero%20cotizar%20la%20colecci%C3%B3n%20seda"
  ...
  const modelo1Product = {
    ...
    description:
      "Bata en seda suave y elegante, perfecta para servicios profesionales de estética, spa y bienestar.",
    colorVariants: [
      {
        name: "BLANCO",
        color: "#e8eff3",
  ...
  const modelo2Product = {
    ...
    description:
      "Estraplera en seda con diseño moderno y funcional. Disponible en los tonos de la línea Seda.",
    colorVariants: [
      {
        name: "BLANCO",
        color: "#e8eff3",
  ...
  const modelo3Product = {
    ...
    basePrice: 20000,
    pricing: {},
    description: "Balaca en seda con caucho, disponible en los mismos colores de la línea Seda.",
    colorVariants: [
      {
        name: "BLANCO",
        color: "#e8eff3",
