...
const greyData = {
  name: "Bata Médica GREY",
  description:
    "Sofisticación moderna para el profesional de hoy. Diseño ergonómico con tela antiarrugas, transpirable y múltiples bolsillos funcionales.",
  colorVariants: [
    {
      name: "Negro",
      color: "#000000",
      description: "Bata negra con uniforme azul",
      images: [
        "/images/grey-black-1.jpg",
        "/images/grey-black-2.jpg",
        "/images/grey-black-3.jpg",
        "/images/grey-black-4.jpg",
        "/images/grey-black-5.jpg",
      ],
    },
    {
      name: "Blanco",
      color: "#FFFFFF",
      description: "Bata blanca con uniforme negro",
      images: [
        "/images/grey-white-1.jpg",
        "/images/grey-white-2.jpg",
        "/images/grey-white-3.jpg",
        "/images/grey-white-4.jpg",
        "/images/grey-white-5.jpg",
      ],
    },
  ],
  sizes: ["S", "M", "L", "XL"],
  ...
  specs: [
    { name: "Material", value: "Mezcla Premium Antiarrugas" },
    { name: "Peso", value: "200 GSM" },
    { name: "Colores", value: "Negro y Blanco" },
    { name: "Tallas", value: "S, M, L, XL" },
    { name: "Cuidado", value: "Lavable a máquina" },
  ],
  features: [
    "Diseño ergonómico y moderno",
    "Tela antiarrugas de alta calidad",
    "Transpirable y cómoda",
    "Múltiples bolsillos funcionales",
    "Corte moderno y favorecedor",
    "Dos opciones de color elegantes",
  ],
}

export default function GreyGallery() {
  const [currentImageIndex, setCurrentImageIndex] = useState(0)
  const [selectedColor, setSelectedColor] = useState(greyData.colorVariants[0].name)
  const [selectedSize, setSelectedSize] = useState("M")

  const currentVariant = greyData.colorVariants.find((v) => v.name === selectedColor) || greyData.colorVariants[0]
  const currentPrice = greyData.pricing[selectedSize as keyof typeof greyData.pricing]
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12">
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="relative aspect-[3/4] max-w-xs sm:max-w-sm mx-auto">
            <Image
              ...
              alt={`${greyData.name} - ${selectedColor}`}
              fill
            ...
            <Dialog>
              ...
              <DialogContent className="max-w-4xl">
                <div className="relative aspect-[3/4] w-full">
                  <Image
                    src={currentVariant.images[currentImageIndex] || "/placeholder.svg"}
                    alt={`${greyData.name} - Vista ampliada`}
                    fill
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="space-y-3 sm:space-y-4">
            <div>
              ...
              <div className="flex gap-2 sm:gap-3 justify-center lg:justify-start">
                {greyData.colorVariants.map((variant) => (
                  <button
                    key={variant.name}
                    onClick={() => {
          ...
          <div className="space-y-2 sm:space-y-3">
            <QuoteButton
              productName={`${greyData.name} ${selectedColor} - Talla ${selectedSize}`}
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              {greyData.features.map((feature, index) => (
