...
const yangData = {
  name: "Bata Médica YANG",
  description:
    "Innovación y tecnología en cada fibra. Diseño de vanguardia con propiedades antimicrobianas, control de temperatura y máxima durabilidad.",
  colorVariants: [
    {
      name: "Rosa",
      color: "#d4a5a5",
      description: "Elegante color rosa profesional",
      images: [
    ...
    },
    {
      name: "Verde Salvia",
      color: "#8b9d8b",
      description: "Sofisticado verde salvia moderno",
      images: [
        "/images/yang-green-1.jpg",
        "/images/yang-green-2.jpg",
        "/images/yang-green-3.jpg",
        "/images/yang-green-1.jpg",
      ],
    },
  ],
  ...
  specs: [
    { name: "Material", value: "Fibra Tecnológica Premium" },
    { name: "Peso", value: "190 GSM" },
    { name: "Colores", value: "Rosa, Verde Salvia" },
    { name: "Tallas", value: "S, M, L, XL" },
    { name: "Cuidado", value: "Tecnología Easy Care" },
    { name: "Garantía", value: "12 meses" },
  ],
  features: [
    "Tecnología antimicrobiana avanzada",
    "Repelente a líquidos y manchas",
    "Control de temperatura corporal",
    "Diseño ergonómico inteligente",
    "Máxima durabilidad y resistencia",
    "Cremallera de alta calidad",
  ],
}

export default function YangGallery() {
  const [currentImageIndex, setCurrentImageIndex] = useState(0)
  const [selectedColor, setSelectedColor] = useState(yangData.colorVariants[0].name)
  const [selectedSize, setSelectedSize] = useState("M")

  const currentVariant = yangData.colorVariants.find((v) => v.name === selectedColor) || yangData.colorVariants[0]
  const currentPrice = yangData.pricing[selectedSize as keyof typeof yangData.pricing]
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12">
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="relative aspect-[3/4] max-w-xs sm:max-w-sm mx-auto">
            <Image
              ...
              alt={`${yangData.name} - ${selectedColor}`}
              fill
            ...
            <Dialog>
              ...
              <DialogContent className="max-w-4xl">
                <div className="relative aspect-[3/4] w-full">
                  <Image
                    src={currentVariant.images[currentImageIndex] || "/placeholder.svg"}
                    alt={`${yangData.name} - Vista ampliada`}
                    fill
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="space-y-3 sm:space-y-4">
            <div>
              ...
              <div className="flex gap-2 sm:gap-3 justify-center lg:justify-start">
                {yangData.colorVariants.map((variant) => (
                  <button
                    key={variant.name}
                    onClick={() => {
          ...
          <div className="space-y-2 sm:space-y-3">
            <QuoteButton
              productName={`${yangData.name} ${selectedColor} - Talla ${selectedSize}`}
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              {yangData.features.map((feature, index) => (
