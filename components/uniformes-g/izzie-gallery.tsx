...
const izzieData = {
  name: "Bata Médica IZZIE",
  description:
    "Comodidad excepcional para largas jornadas. Diseño moderno en azul marino con cierre de cremallera dorada, bolsillos funcionales y corte favorecedor.",
  colorVariants: [
    {
      name: "Azul Marino",
      color: "#1e3a5f",
      description: "Elegante azul marino profesional",
  ...
  specs: [
    { name: "Material", value: "Algodón Premium Suave" },
    { name: "Peso", value: "160 GSM" },
  ...
  features: [
    ...
    "Máxima comodidad para largas jornadas",
    "Libertad de movimiento total",
    "Diseño funcional con múltiples bolsillos",
    "Fácil mantenimiento y cuidado",
    "Cierre de cremallera elegante",
  ],
}

export default function IzzieGallery() {
  const [currentImageIndex, setCurrentImageIndex] = useState(0)
  const [selectedColor, setSelectedColor] = useState(izzieData.colorVariants[0].name)
  const [selectedSize, setSelectedSize] = useState("M")

  const currentVariant = izzieData.colorVariants.find((v) => v.name === selectedColor) || izzieData.colorVariants[0]
  const currentPrice = izzieData.pricing[selectedSize as keyof typeof izzieData.pricing]
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12">
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="relative aspect-[3/4] max-w-xs sm:max-w-sm mx-auto">
            <Image
              ...
              alt={`${izzieData.name} - ${selectedColor}`}
              fill
            ...
            <Dialog>
              ...
              <DialogContent className="max-w-4xl">
                <div className="relative aspect-[3/4] w-full">
                  <Image
                    src={currentVariant.images[currentImageIndex] || "/placeholder.svg"}
                    alt={`${izzieData.name} - Vista ampliada`}
                    fill
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="space-y-3 sm:space-y-4">
            <div>
              ...
              <div className="flex gap-2 sm:gap-3 justify-center lg:justify-start">
                {izzieData.colorVariants.map((variant) => (
                  <button
                    key={variant.name}
                    onClick={() => {
          ...
          <div className="space-y-2 sm:space-y-3">
            <QuoteButton
              productName={`${izzieData.name} ${selectedColor} - Talla ${selectedSize}`}
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              {izzieData.features.map((feature, index) => (
